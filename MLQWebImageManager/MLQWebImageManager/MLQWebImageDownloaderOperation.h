//
//  MLQWebImageDownloaderOperation.h
//  MLQWebImageManager
//
...
/**
 The download operation class for MLQWebImageDownloader.
 */
@interface MLQWebImageDownloaderOperation : NSOperation <SDWebImageDownloaderOperation>
